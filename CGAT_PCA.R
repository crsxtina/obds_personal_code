...
## Dataset 1
## Look at the data
#system("head /Users/vi/Dropbox/WIMM/CGAT/data_david/obds_sampletable.csv")

## Load the data into R
#a = read.table("/Users/vi/Dropbox/WIMM/CGAT/data_david/obds_sampletable.csv")
## check the size of the data
#dim(a) # 12 samples
## Split Sample_accession into different parts and create columns for each of them in the data frame
#m = matrix(unlist(strsplit(as.character(a$Sample_accession),"_",fixed=TRUE)),byrow=T,ncol=4)
